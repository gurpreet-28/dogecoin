...
st.set_page_config(
    ...
    page_icon="https://cryptologos.cc/logos/dogecoin-doge-logo.png?v=032"
)

st.title("Dogecoin Predicted Price")
st.write("Welcome to our Dogecoin Price Prediction page, where we leverage advanced machine learning models to forecast future prices of Dogecoin. Utilizing historical data and sophisticated algorithms, we provide an interactive and visually engaging representation of predicted Dogecoin prices.")

maindf = pd.read_csv('DOGE-USD.csv')

closedf = maindf[['Date', 'Close']]

closedf = closedf[closedf['Date'] > '2021-06-19']
close_Dogecoin = closedf.copy()
...
fig = px.line(new_pred_plot, x=new_pred_plot.index, y=[new_pred_plot['last_original_days_value'],
              ...
              labels={'value': 'Dogecoin price', 'index': 'Timestamp'})
